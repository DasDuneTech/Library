...
let toggle = async(e) => {
  ...
  let ele = popEle({e:`ul`, i:`item-1`, p:document.getElementById('treeRoot')})
  let ele2 = popEle({e: `li`, p:ele})
  ele = popEle({e: `span`, i:`item1`, c:`item`, t:`item 1`, p:ele2})
  ele.addEventListener("click", (e) => toggle(e))

  ele = popEle({e:`ul`, i:`item-2`, p:document.getElementById('treeRoot')})
  ele2 = popEle({e: `li`, p:ele})
  ele = popEle({e: `span`, i:`item1`, c:`item`, t:`item 2`, p:ele2})
  ele.addEventListener("click", (e) => toggle(e))

  let ele3 = popEle({e: `ul`, i:`item-2-1`, c:`nested`, p:ele.parentElement})
  ...
  ele2 = popEle({e: `li`, p:ele3})
  ele = popEle({e: `span`, i:`root`, c:`item`, t:`item 2-2`, p:ele2})
  ele.addEventListener("click", (e) => toggle(e))

  ele3 = popEle({e: `ul`, i:`item-2-2-1`, c:`nested`, p:ele2})

  ele2 = popEle({e: `li`, p:ele3})
  ele = popEle({e: `span`, i:`root`, c:`item`, t:`item 2-2-1`, p:ele2})
  ele.addEventListener("click", (e) => toggle(e))